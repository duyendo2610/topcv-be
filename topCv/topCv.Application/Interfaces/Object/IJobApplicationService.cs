...
namespace topCv.Application.Interfaces.Obj
{
    public interface IJobApplicationService
    {
        ...
        Task<JobApplicationResponse> UpdateStatusAsync(Guid applicationId, UpdateJobApplicationStatusRequest req, Guid employerUserId, CancellationToken ct);

        // Candidate sửa nội dung đơn (optional nhưng clean)
        Task<JobApplicationResponse> UpdateMyApplicationAsync(Guid applicationId, UpdateJobApplicationRequest req, Guid userId, CancellationToken ct);
    }
}

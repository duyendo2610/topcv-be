...
namespace topCv.Application.Services.Obj
{
    public sealed class JobApplicationService : IJobApplicationService
    {
        ...
        public async Task<JobApplicationResponse> ApplyAsync(CreateJobApplicationRequest req, Guid userId, CancellationToken ct)
        {
        ...
        public async Task<List<JobApplicationResponse>> GetByJobAsync(Guid jobId, Guid employerUserId, CancellationToken ct)
        {
            var job = await _db.Jobs
            .AsNoTracking()
        ...
        public async Task<JobApplicationResponse> UpdateMyApplicationAsync(Guid applicationId, UpdateJobApplicationRequest req, Guid userId, CancellationToken ct)
        {
        ...
        public async Task<JobApplicationResponse> UpdateStatusAsync(Guid applicationId, UpdateJobApplicationStatusRequest req, Guid employerUserId, CancellationToken ct)
        {

...
namespace topCv.Infrastructure.Migrations
{
    ...
    [Migration("20260305091724_AddJobSubmittedAtUtc")]
    partial class AddJobSubmittedAtUtc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.CandidateProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.EmployerRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmployerRequests", (string)null);
                });

            modelBuilder.Entity("topCv.Domain.Entities.Commons.FollowCompany", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobCategory", b =>
                {
                    b.Property<Guid>("JobId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobSkill", b =>
                {
                    b.Property<Guid>("JobId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.ResumeFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.ResumeSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Ward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.CandidateProfile", b =>
                {
                    b.HasOne("topCv.Domain.Entities.Commons.Province", "Province")
                    ...
                    b.HasOne("topCv.Domain.Entities.Auth.User", "User")
                        ...
                        .HasForeignKey("topCv.Domain.Entities.Commons.CandidateProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.Category", b =>
                {
                    b.HasOne("topCv.Domain.Entities.Commons.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.EmployerRequest", b =>
                {
                    b.HasOne("topCv.Domain.Entities.Commons.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobApplication", b =>
                {
                    ...
                    b.HasOne("topCv.Domain.Entities.Commons.Job", "Job")
                        .WithMany("JobApplications")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("topCv.Domain.Entities.Commons.ResumeFile", "ResumeFile")
                        .WithMany("JobApplications")
                        .HasForeignKey("ResumeFileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("topCv.Domain.Entities.Commons.Resume", "Resume")
                        .WithMany("JobApplications")
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobCategory", b =>
                {
                    b.HasOne("topCv.Domain.Entities.Commons.Category", "Category")
            ...
            modelBuilder.Entity("topCv.Domain.Entities.Commons.JobSkill", b =>
                {
                    ...
                    b.HasOne("topCv.Domain.Entities.Commons.Skill", "Skill")
                        .WithMany("JobSkills")
